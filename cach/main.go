...
func found() (string, error) {
	...
	req, err := http.NewRequest("GET", "https://api.meteomatics.com/2025-03-15T00:00:00Z/t_2m:C/36.3,59.6/json", nil)
	if err != nil {
		return "", err
	}
...
func main() {
	...
	if err != nil {
		log.Fatalf("not conect %v", err)
	} else {
		fmt.Println("connect in redis")
	}
